# GOAL-MVP-148 Backlog Item RFB-RC016-001

## Goal ID

```text
GOAL-MVP-148_BACKLOG_ITEM_RFB_RC016_001
```
...
```text
Add folded-state review source-decision metadata to required archive evidence so the RC016 screenshot requirement is traceable to a concrete reviewer decision.
```
...
goal_card=docs/goals/GOAL-MVP-148_BACKLOG_ITEM_RFB_RC016_001.md
closeout=docs/S6_FAST_MVP_GOAL_MVP_148_BACKLOG_ITEM_RFB_RC016_001_2026_05_09.md
```
...
GOAL-MVP-147 implementation commit 15d6558
```

## Output paths

```text
docs/goals/GOAL-MVP-148_BACKLOG_ITEM_RFB_RC016_001.md
scripts/build_local_offline_trial_rc.py
backend/tests/test_build_local_offline_trial_rc.py
docs/S6_FAST_MVP_GOAL_MVP_148_BACKLOG_ITEM_RFB_RC016_001_2026_05_09.md
```
...
```text
small package evidence-contract hardening for folded-state review decision traceability
...
```text
py -3 scripts/validate_codex_goal_card.py docs/goals/GOAL-MVP-148_BACKLOG_ITEM_RFB_RC016_001.md
...
unittest PASS output proving folded-state review source decision metadata exists in package manifest/package index/screenshot index pathways
builder help command PASS output
diff --check PASS output
closeout record mapping RFB-RC016-001 to reviewer decision traceability hardening
```
...
commit message: feat(secupilot): GOAL-MVP-148 folded screenshot source decision
