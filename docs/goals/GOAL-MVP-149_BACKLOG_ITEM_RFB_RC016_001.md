# GOAL-MVP-149 Backlog Item RFB-RC016-001

## Goal ID

```text
GOAL-MVP-149_BACKLOG_ITEM_RFB_RC016_001
```
...
```text
Add folded-state review source-type metadata so required archive evidence explicitly records the RC016 feedback classification.
```
...
goal_card=docs/goals/GOAL-MVP-149_BACKLOG_ITEM_RFB_RC016_001.md
closeout=docs/S6_FAST_MVP_GOAL_MVP_149_BACKLOG_ITEM_RFB_RC016_001_2026_05_09.md
```
...
GOAL-MVP-148 implementation commit 03fc603
```

## Output paths

```text
docs/goals/GOAL-MVP-149_BACKLOG_ITEM_RFB_RC016_001.md
scripts/build_local_offline_trial_rc.py
backend/tests/test_build_local_offline_trial_rc.py
docs/S6_FAST_MVP_GOAL_MVP_149_BACKLOG_ITEM_RFB_RC016_001_2026_05_09.md
```
...
```text
small package evidence-contract hardening for folded-state review source-type traceability
...
```text
py -3 scripts/validate_codex_goal_card.py docs/goals/GOAL-MVP-149_BACKLOG_ITEM_RFB_RC016_001.md
...
unittest PASS output proving folded-state review source type metadata exists in package manifest/package index/screenshot index pathways
builder help command PASS output
diff --check PASS output
closeout record mapping RFB-RC016-001 to source-type traceability hardening
```
...
commit message: feat(secupilot): GOAL-MVP-149 folded screenshot source type
