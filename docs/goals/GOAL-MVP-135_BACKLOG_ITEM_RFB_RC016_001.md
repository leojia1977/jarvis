# GOAL-MVP-135 Backlog Item RFB-RC016-001

## Goal ID

```text
GOAL-MVP-135_BACKLOG_ITEM_RFB_RC016_001
```
...
```text
Add a canonical folded-state capture-phase contract so archive evidence explicitly identifies FIRST_LOAD semantics in manifest and package index payloads.
```
...
goal_card=docs/goals/GOAL-MVP-135_BACKLOG_ITEM_RFB_RC016_001.md
closeout=docs/S6_FAST_MVP_GOAL_MVP_135_BACKLOG_ITEM_RFB_RC016_001_2026_05_09.md
```
...
GOAL-MVP-134 implementation commit f4aad9b
```

## Output paths

```text
docs/goals/GOAL-MVP-135_BACKLOG_ITEM_RFB_RC016_001.md
scripts/build_local_offline_trial_rc.py
backend/tests/test_build_local_offline_trial_rc.py
docs/S6_FAST_MVP_GOAL_MVP_135_BACKLOG_ITEM_RFB_RC016_001_2026_05_09.md
```
...
```text
small package evidence-contract hardening for folded-state capture phase
...
```text
py -3 scripts/validate_codex_goal_card.py docs/goals/GOAL-MVP-135_BACKLOG_ITEM_RFB_RC016_001.md
...
unittest PASS output proving folded-state capture-phase contract
builder help command PASS output
diff --check PASS output
closeout record mapping RFB-RC016-001 to FIRST_LOAD capture-phase proof
```
...
commit message: feat(secupilot): GOAL-MVP-135 folded screenshot capture phase
