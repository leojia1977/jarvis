# GOAL-MVP-134 Backlog Item RFB-RC016-001

## Goal ID

```text
GOAL-MVP-134_BACKLOG_ITEM_RFB_RC016_001
```
...
```text
Add a canonical first-load expected-interaction-count contract into archive evidence so folded-state screenshot proof explicitly binds to zero interaction behavior.
```
...
goal_card=docs/goals/GOAL-MVP-134_BACKLOG_ITEM_RFB_RC016_001.md
closeout=docs/S6_FAST_MVP_GOAL_MVP_134_BACKLOG_ITEM_RFB_RC016_001_2026_05_09.md
```
...
GOAL-MVP-133 implementation commit c4d229d
```

## Output paths

```text
docs/goals/GOAL-MVP-134_BACKLOG_ITEM_RFB_RC016_001.md
scripts/build_local_offline_trial_rc.py
backend/tests/test_build_local_offline_trial_rc.py
docs/S6_FAST_MVP_GOAL_MVP_134_BACKLOG_ITEM_RFB_RC016_001_2026_05_09.md
```
...
```text
small package evidence-contract hardening for folded-state expected interaction count
...
```text
py -3 scripts/validate_codex_goal_card.py docs/goals/GOAL-MVP-134_BACKLOG_ITEM_RFB_RC016_001.md
...
unittest PASS output proving first-load zero-interaction evidence contract
builder help command PASS output
diff --check PASS output
closeout record mapping RFB-RC016-001 to expected interaction-count proof
```
...
commit message: feat(secupilot): GOAL-MVP-134 folded screenshot expected interaction count
