# GOAL-MVP-153 Backlog Item RFB-RC016-001

## Goal ID

```text
GOAL-MVP-153_BACKLOG_ITEM_RFB_RC016_001
```
...
```text
Add folded-state review source-status metadata so archive evidence records the live backlog state for the exact RC016 screenshot obligation.
```
...
goal_card=docs/goals/GOAL-MVP-153_BACKLOG_ITEM_RFB_RC016_001.md
closeout=docs/S6_FAST_MVP_GOAL_MVP_153_BACKLOG_ITEM_RFB_RC016_001_2026_05_09.md
```
...
```text
docs/goals/GOAL-MVP-153_BACKLOG_ITEM_RFB_RC016_001.md
scripts/build_local_offline_trial_rc.py
backend/tests/test_build_local_offline_trial_rc.py
docs/S6_FAST_MVP_GOAL_MVP_153_BACKLOG_ITEM_RFB_RC016_001_2026_05_09.md
```
...
```text
small package evidence-contract hardening for folded-state review source-status traceability
...
```text
py -3 scripts/validate_codex_goal_card.py docs/goals/GOAL-MVP-153_BACKLOG_ITEM_RFB_RC016_001.md
...
unittest PASS output proving folded-state review source status metadata exists in package manifest/package index/screenshot index pathways
builder help command PASS output
diff --check PASS output
closeout record mapping RFB-RC016-001 to source-status traceability hardening
```
...
commit message: feat(secupilot): GOAL-MVP-153 folded screenshot source title
