# GOAL-MVP-137 Backlog Item RFB-RC016-001

## Goal ID

```text
GOAL-MVP-137_BACKLOG_ITEM_RFB_RC016_001
```
...
```text
Bind folded-state screenshot archive evidence to a direct screenshot hash so reviewers can verify no-interaction folded proof without cross-file reconstruction.
```
...
goal_card=docs/goals/GOAL-MVP-137_BACKLOG_ITEM_RFB_RC016_001.md
closeout=docs/S6_FAST_MVP_GOAL_MVP_137_BACKLOG_ITEM_RFB_RC016_001_2026_05_09.md
```
...
GOAL-MVP-136 implementation commit f1d6264
```

## Output paths

```text
docs/goals/GOAL-MVP-137_BACKLOG_ITEM_RFB_RC016_001.md
scripts/build_local_offline_trial_rc.py
backend/tests/test_build_local_offline_trial_rc.py
docs/S6_FAST_MVP_GOAL_MVP_137_BACKLOG_ITEM_RFB_RC016_001_2026_05_09.md
```
...
```text
small package evidence-contract hardening for folded-state screenshot hash binding
...
```text
py -3 scripts/validate_codex_goal_card.py docs/goals/GOAL-MVP-137_BACKLOG_ITEM_RFB_RC016_001.md
...
unittest PASS output proving folded screenshot archive_evidence.sha256 matches screenshot hash
builder help command PASS output
diff --check PASS output
closeout record mapping RFB-RC016-001 to screenshot hash-bound folded evidence
```
...
commit message: feat(secupilot): GOAL-MVP-137 folded screenshot hash binding
