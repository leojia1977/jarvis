# GOAL-MVP-156 Backlog Item RFB-RC016-001

## Goal ID

```text
GOAL-MVP-156_BACKLOG_ITEM_RFB_RC016_001
```
...
```text
Add folded-state review source-feedback path metadata so archive evidence can trace back to the exact reviewer feedback source.
```
...
goal_card=docs/goals/GOAL-MVP-156_BACKLOG_ITEM_RFB_RC016_001.md
closeout=docs/S6_FAST_MVP_GOAL_MVP_156_BACKLOG_ITEM_RFB_RC016_001_2026_05_09.md
```
...
GOAL-MVP-155 implementation commit 6e20d41
```

## Output paths

```text
docs/goals/GOAL-MVP-156_BACKLOG_ITEM_RFB_RC016_001.md
scripts/build_local_offline_trial_rc.py
backend/tests/test_build_local_offline_trial_rc.py
docs/S6_FAST_MVP_GOAL_MVP_156_BACKLOG_ITEM_RFB_RC016_001_2026_05_09.md
```
...
```text
small package evidence-contract hardening for folded-state feedback-source traceability
...
```text
py -3 scripts/validate_codex_goal_card.py docs/goals/GOAL-MVP-156_BACKLOG_ITEM_RFB_RC016_001.md
...
unittest PASS output proving folded-state source-feedback metadata exists in package manifest/package index/screenshot index pathways
builder help command PASS output
diff --check PASS output
closeout record mapping RFB-RC016-001 to source-feedback traceability hardening
```
...
commit message: feat(secupilot): GOAL-MVP-156 folded screenshot feedback source
