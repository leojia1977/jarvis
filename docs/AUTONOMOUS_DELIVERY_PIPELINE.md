...
5. SWE agent remains execution HOLD unless human-controlled WSL2/PTY provisioning plus a separate governed no-write dry-run verification route passes and a later Yellow item explicitly allows it as a bounded implementation accelerator.
