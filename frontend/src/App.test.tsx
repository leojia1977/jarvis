...
describe("SecuPilot first-batch workbench slice", () => {
  ...
  it("opens the S1 artifact viewer from the workbench without action controls", async () => {
    ...
    expect(reviewPanel).toHaveAttribute("data-review-scope", "LOCAL_OFFLINE_TRIAL_RC_012_CN");
    expect(reviewPanel).toHaveAttribute("data-source-candidate", "LOCAL_OFFLINE_TRIAL_RC_011_CN");
    ...
    expect(screen.getByTestId("s1-review-zip-name")).toHaveTextContent(
      "local-offline-trial-rc-012-cn-review-package-20260507.zip"
    );
