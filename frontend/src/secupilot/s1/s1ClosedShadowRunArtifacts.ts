...
export const S1_CLOSED_SHADOW_RUN_ARTIFACTS = {
  ...
  exitCode: 10,
  passHoldReason:
    "Closed-shadow fixture metadata capture completed；RC-016 本地/离线评审包用于验证 MVP-43 技术对账说明文字清晰化。",
  reviewerAction: "LOCAL_OFFLINE_REVIEW_READY",
  nextStep: "RC016_LOCAL_OFFLINE_REVIEW",
  caseCount: 20,
  qwenUsed: false,
  ...
  localReview: {
    ...
    sourceCandidate: "LOCAL_OFFLINE_TRIAL_RC_015_CN",
    ...
    defaultNotes:
      "RC-016 本地/离线评审包用于验证 MVP-43 技术对账说明文字清晰化；客户可见、部署、真实数据、live Qwen/API、connector 仍未授权。",
    handoff: {
      reviewMode: "LOCAL_OFFLINE_REVIEW_ONLY",
      packagePath: "artifacts/local_demo_packages/local-offline-trial-rc-016-cn-review",
      readmePath:
        "artifacts/local_demo_packages/local-offline-trial-rc-016-cn-review/REVIEWER_START_HERE_中文.md",
      zipName: "local-offline-trial-rc-016-cn-review-package-20260507.zip",
      requiredChecks: [
  ...
  localTrial: {
    ...
    routeDecisionDoc:
      "docs/S6_FAST_MVP_MVP_45_RC016_REVIEW_PACKAGE_AFTER_MVP43_CLOSEOUT_2026_05_07.md",
    closeoutDoc:
      "docs/S6_FAST_MVP_MVP_45_RC016_REVIEW_PACKAGE_AFTER_MVP43_CLOSEOUT_2026_05_07.md",
    packagePath: "artifacts/local_demo_packages/local-offline-trial-rc-016-cn-review",
    readmePath:
      "artifacts/local_demo_packages/local-offline-trial-rc-016-cn-review/REVIEWER_START_HERE_中文.md",
    launcherOutputPath:
      "artifacts/local_trial_launches/local-offline-trial-rc-016-cn-review/launch_info.json",
    localUrl: "http://127.0.0.1:4174/s1-trial",
    deliveryPackagePath: "artifacts/local_demo_packages/local-offline-trial-rc-016-cn-review",
    startHerePath:
      "artifacts/local_demo_packages/local-offline-trial-rc-016-cn-review/REVIEWER_START_HERE_中文.md",
    reviewerChecklistPath:
      "artifacts/local_demo_packages/local-offline-trial-rc-016-cn-review/REVIEWER_CHECKLIST_中文.md",
    feedbackTemplatePath:
      "artifacts/local_demo_packages/local-offline-trial-rc-016-cn-review/FEEDBACK_TEMPLATE_中文.md",
    packageIndexPath:
    ...
    steps: [
      ...
      },
      {
        ...
        artifactRef:
          "artifacts/local_demo_packages/local-offline-trial-rc-016-cn-review/screenshots/"
      }
