...
export const S1_CLOSED_SHADOW_RUN_ARTIFACTS = {
  ...
  exitCode: 10,
  passHoldReason:
    "Closed-shadow fixture metadata capture completed；RC-020 用于验证私有化预览 RC 包刷新、客户任务流、Qwen readiness 证据和本地离线边界一致。",
  reviewerAction: "LOCAL_OFFLINE_REVIEW_READY",
  nextStep: "RC020_PRIVATE_PREVIEW_RC_PACKAGE_REVIEW",
  caseCount: 20,
  qwenUsed: false,
  ...
  localReview: {
    ...
    sourceCandidate: "LOCAL_OFFLINE_TRIAL_RC_019_CN",
    ...
    defaultNotes:
      "RC-020 本地/离线评审包用于验证私有化预览 RC 包刷新、客户任务流和产品 route map 已进入客户试用入口，并保留 Qwen readiness 证据；客户可见、部署、真实数据、live Qwen/API、connector 仍未授权。",
    handoff: {
      reviewMode: "LOCAL_OFFLINE_REVIEW_ONLY",
      packagePath: "artifacts/local_demo_packages/local-offline-trial-rc-020-cn-review",
      readmePath:
        "artifacts/local_demo_packages/local-offline-trial-rc-020-cn-review/REVIEWER_START_HERE_中文.md",
      zipName: "local-offline-trial-rc-020-cn-review-package-20260508.zip",
      requiredChecks: [
  ...
  localTrial: {
    ...
    deliveryPackagePath: "artifacts/local_demo_packages/local-offline-trial-rc-020-cn-review",
    startHerePath:
      "artifacts/local_demo_packages/local-offline-trial-rc-020-cn-review/REVIEWER_START_HERE_中文.md",
    reviewerChecklistPath:
      "artifacts/local_demo_packages/local-offline-trial-rc-020-cn-review/REVIEWER_CHECKLIST_中文.md",
    feedbackTemplatePath:
      "artifacts/local_demo_packages/local-offline-trial-rc-020-cn-review/FEEDBACK_TEMPLATE_中文.md",
    packageIndexPath:
      "artifacts/local_demo_packages/local-offline-trial-rc-020-cn-review/package_manifest.json",
    steps: [
      {
        id: "readme",
        title: "打开评审 README",
      ...
      },
      {
        ...
        artifactRef:
          "artifacts/local_demo_packages/local-offline-trial-rc-020-cn-review/evidence/final_status.json"
      },
      {
        id: "safety",
        title: "确认安全扫描",
        ...
        artifactRef:
          "artifacts/local_demo_packages/local-offline-trial-rc-020-cn-review/evidence/safety_scan.json"
      },
      {
        id: "screenshots",
        title: "检查桌面和移动端截图",
        ...
        artifactRef:
          "artifacts/local_demo_packages/local-offline-trial-rc-020-cn-review/screenshots/"
      }
