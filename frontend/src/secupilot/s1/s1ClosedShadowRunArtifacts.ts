...
export const S1_CLOSED_SHADOW_RUN_ARTIFACTS = {
  ...
  exitCode: 10,
  passHoldReason:
    "Closed-shadow fixture metadata capture completed；RC-018 用于验证客户试用入口清理、Qwen readiness 证据和本地离线边界一致。",
  reviewerAction: "LOCAL_OFFLINE_REVIEW_READY",
  nextStep: "RC018_CUSTOMER_TRIAL_ENTRY_REVIEW",
  caseCount: 20,
  qwenUsed: false,
  ...
  localReview: {
    ...
    sourceCandidate: "LOCAL_OFFLINE_TRIAL_RC_017_CN",
    ...
    defaultNotes:
      "RC-018 本地/离线评审包用于验证客户试用入口第一屏更接近产品体验，并保留 Qwen synthetic provider readiness 证据；客户可见、部署、真实数据、live Qwen/API、connector 仍未授权。",
    handoff: {
      reviewMode: "LOCAL_OFFLINE_REVIEW_ONLY",
      packagePath: "artifacts/local_demo_packages/local-offline-trial-rc-018-cn-review",
      readmePath:
        "artifacts/local_demo_packages/local-offline-trial-rc-018-cn-review/REVIEWER_START_HERE_中文.md",
      zipName: "local-offline-trial-rc-018-cn-review-package-20260508.zip",
      requiredChecks: [
  ...
  localTrial: {
    ...
    readmePath:
      "artifacts/local_demo_packages/local-offline-trial-rc-018-cn-review/REVIEWER_START_HERE_中文.md",
    launcherOutputPath:
      "artifacts/local_trial_launches/local-offline-trial-rc-018-cn-review/launch_info.json",
    localUrl: "http://127.0.0.1:4174/s1-trial",
    deliveryPackagePath: "artifacts/local_demo_packages/local-offline-trial-rc-018-cn-review",
    startHerePath:
      "artifacts/local_demo_packages/local-offline-trial-rc-018-cn-review/REVIEWER_START_HERE_中文.md",
    reviewerChecklistPath:
      "artifacts/local_demo_packages/local-offline-trial-rc-018-cn-review/REVIEWER_CHECKLIST_中文.md",
    feedbackTemplatePath:
      "artifacts/local_demo_packages/local-offline-trial-rc-018-cn-review/FEEDBACK_TEMPLATE_中文.md",
    packageIndexPath:
    ...
    steps: [
      ...
      },
      {
        ...
        artifactRef:
          "artifacts/local_demo_packages/local-offline-trial-rc-018-cn-review/evidence/final_status.json"
      },
      {
        id: "safety",
        title: "确认安全扫描",
        ...
        artifactRef:
          "artifacts/local_demo_packages/local-offline-trial-rc-018-cn-review/evidence/safety_scan.json"
      },
      {
        id: "screenshots",
        title: "检查桌面和移动端截图",
        ...
        artifactRef:
          "artifacts/local_demo_packages/local-offline-trial-rc-018-cn-review/screenshots/"
      }
