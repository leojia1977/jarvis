...
| 截图中 candidate 为 `LOCAL_OFFLINE_TRIAL_RC_020_CN` | PASS |
| 截图中 source candidate 为 `LOCAL_OFFLINE_TRIAL_RC_019_CN` | PASS |
| 截图中 package path 指向 `local-offline-trial-rc-020-cn-review` | PASS |
