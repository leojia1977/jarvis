...
| `/s1-run` 截图为中文优先 | PASS |
| 截图中 candidate 为 `LOCAL_OFFLINE_TRIAL_RC_008_CN` | PASS |
| 截图中 source candidate 为 `LOCAL_OFFLINE_TRIAL_RC_007_CN` | PASS |
| 截图中 package path 指向 `local-offline-trial-rc-008-cn-review` | PASS |
...
```text
完整 P1/P2/P3 主 workbench 信息架构仍需后续产品化重构
S1 local trial 页面仍偏 evidence/reviewer workflow，不是最终客户首页
```
