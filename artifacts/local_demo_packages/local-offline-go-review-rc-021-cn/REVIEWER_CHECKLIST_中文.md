...
| 截图中 candidate 为 `LOCAL_OFFLINE_GO_REVIEW_RC_021_CN` | PASS |
| 截图中 source candidate 为 `LOCAL_OFFLINE_TRIAL_RC_020_CN` | PASS |
| 截图中 package path 指向 `local-offline-go-review-rc-021-cn` | PASS |
