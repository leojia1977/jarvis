...
| 截图中 candidate 为 `LOCAL_OFFLINE_TRIAL_RC_009_CN` | PASS |
| 截图中 source candidate 为 `LOCAL_OFFLINE_TRIAL_RC_008_CN` | PASS |
| 截图中 package path 指向 `local-offline-trial-rc-009-cn-review` | PASS |
